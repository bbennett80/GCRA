...
def age_first_live_birth():
     return st.sidebar.slider('Age of First Live Birth', 16, 50, 1)

def oral_contraceptive_use():
    return st.sidebar.selectbox('Have you used oral birth control?', ('Yes', 'No'), help='This refers to birth control pill')

def hrt():
    return st.sidebar.selectbox('Have you used post-menopause hormone replacement?', ('Yes', 'No'))
...
def alcohol_intake():
    return st.sidebar.selectbox('Do you drink alcohol?', ('Yes', 'No'))
...
def tubal_ligation():
    return st.sidebar.selectbox('Have you had a tubal ligation?', ('Yes', 'No'))

def endometriosis():
    return st.sidebar.selectbox('Have you had endometriosis?', ('Yes', 'No'))
...
# pedigree
def pedigree_chart():
    with open('devel/src/index.html') as p:
        pedigree = p.read()
