var pedigree = (function (exports) {
  ...
  function save_file(opts, content, filename, type) {
    ...
    if (!filename) filename = "pedigree.txt";
  ...
  function build(options) {
    var opts = $.extend({
      ...
      labels: ['alleles', ['brca1_gene_test', 'brca2_gene_test', 'palb2_gene_test', 'chek2_gene_test', 'atm_gene_test'], ['rad51d_gene_test', 'rad51c_gene_test', 'brip1_gene_test'], ['er_bc_pathology', 'pr_bc_pathology', 'her2_bc_pathology', 'ck14_bc_pathology', 'ck56_bc_pathology']],
